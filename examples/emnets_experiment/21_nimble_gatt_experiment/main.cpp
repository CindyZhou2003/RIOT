...
#include "mpu6050.h"
#include <stdio.h>
#include <ztimer.h>  // 如果使用 RIOT OS，请导入此头文件
...
#define THREAD_STACKSIZE        (THREAD_STACKSIZE_IDLE+512)
...
static char str_threshold[20];  // 存储阈值的字符串表示
static char str_collect_interval[20];  // 存储采样频率的字符串表示
