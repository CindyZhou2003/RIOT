...
install_arch()
{
    ...
    URL_PATH="https://githubfast.com/espressif/crosstool-NG/releases/download"
...
install_openocd()
{
    ...
    URL_PATH="https://githubfast.com/espressif/openocd-esp32/releases/download"
...
install_qemu()
{
    ...
    URL_PATH="https://githubfast.com/espressif/qemu/releases/download"
...
install_gdb()
{
    ...
    URL_PATH="https://githubfast.com/espressif/binutils-gdb/releases/download"
